                ...
                <div className="p-3.5 flex items-start gap-3.5">
                    ...
                    <div className="flex-1 min-w-0 py-0.5">
                        <div className="flex justify-between items-start mb-0.5">
                            <h4 className="text-xs font-bold text-[var(--text-main)] leading-none truncate pr-4">
                                {senderName}
                            </h4>
                            <span className="text-[9px] text-[var(--text-muted)] font-mono shrink-0">NOW</span>
                        </div>
                    ...
                    <button 
                        ...
                        className="absolute top-0 right-0 p-3 text-[var(--text-muted)] hover:text-[var(--text-main)] active:scale-90 transition-transform"
                    >
                        <X size={14} />
                    </button>
                </div>
